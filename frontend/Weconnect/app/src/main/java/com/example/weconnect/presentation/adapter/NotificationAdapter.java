...
public class NotificationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        if (isActionable && !item.isActioned()) {
            if (NotificationItem.NotificationType.JOIN_REQUEST.name().equals(item.getType())
                ...
                holder.btnAccept.setOnClickListener(v ->
                    friendService.acceptFriendRequest(relUid, com.example.weconnect.data.repository.FirebaseManager.getCurrentUserId(), new FirebaseFriendService.ActionCallback() {
                ...
                holder.btnDecline.setOnClickListener(v ->
                    friendService.declineFriendRequest(relUid, com.example.weconnect.data.repository.FirebaseManager.getCurrentUserId(), new FirebaseFriendService.ActionCallback() {
                        @Override public void onSuccess(String msg) {
    ...
    private void approveJoinRequest(NotificationItem item, NotifViewHolder holder) {
        ...
        postRepo.approveMember(postId, userUid, com.example.weconnect.data.repository.FirebaseManager.getCurrentUserId(), new FirestorePostRepository.ActionCallback() {
